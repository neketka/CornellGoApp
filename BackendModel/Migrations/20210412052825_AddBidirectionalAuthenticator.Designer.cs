...
namespace BackendModel.Migrations
{
    ...
    [Migration("20210412052825_AddBidirectionalAuthenticator")]
    partial class AddBidirectionalAuthenticator
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChallengeGroup", b =>
                {
                    b.Property<long>("GroupsId")
                        .HasColumnType("bigint");

                    b.Property<long>("PrevChallengesId")
                        .HasColumnType("bigint");

                    b.HasKey("GroupsId", "PrevChallengesId");

                    b.HasIndex("PrevChallengesId");

                    b.ToTable("Challenge_Groups_x_Group_PrevChallenges");
                });

            modelBuilder.Entity("BackendModel.Authenticator", b =>
                {
                    b.HasOne("BackendModel.User", "User")
                        .WithOne("Authenticator")
            ...
            modelBuilder.Entity("ChallengeGroup", b =>
                {
                    ...
                    b.HasOne("BackendModel.Challenge", null)
                        .WithMany()
                        .HasForeignKey("PrevChallengesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
